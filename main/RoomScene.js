  ...
  _createClass(RoomScene, [{
    ...
    value: function initFreeRoom(wallType) {
      ...
      this.walls.map(function (wall, wallIndex) {
        ...
        _this12.renderWallMask(wall, _this12.freeRoom, function (mountedTiles) {
